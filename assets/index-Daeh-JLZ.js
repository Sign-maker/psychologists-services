 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tg=function(t){let e={},n={},r={},i="";try{const s=t.split(".");e=Qi(bo(s[0])||""),n=Qi(bo(s[1])||""),i=s[2],r=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:r,signature:i}},y0=function(t){const e=Tg(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},w0=function(t){const e=Tg(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const CE="firebase-heartbeat-database",IE=1,Yi="firebase-heartbeat-store";let pa=null;function Ag(){return pa||(pa=V0(CE,IE,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Yi)}catch(n){console.warn(n)}}}}).catch(t=>{throw un.create("idb-open",{originalErrorMessage:t.message})})),pa}async function TE(t){try{const n=(await Ag()).transaction(Yi),r=await n.objectStore(Yi).get(Og(t));return await n.done,r}catch(e){if(e instanceof In)Gn.warn(e.message);else{const n=un.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Gn.warn(n.message)}}}async function Kh(t,e){try{const r=(await Ag()).transaction(Yi,"readwrite");await r.objectStore(Yi).put(e,Og(t)),await r.done}catch(n){if(n instanceof In)Gn.warn(n.message);else{const r=un.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Gn.warn(r.message)}}}function Og(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */cn(xE,DE,"app");function Bc(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(t);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(t,r[i])&&(n[r[i]]=t[r[i]]);return n}function xg(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const LE=xg,Dg=new ds("auth","Firebase",xg());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hs{constructor(e,n){this.shortDelay=e,this.longDelay=n,Lt(n>e,"Short delay should be less than long delay!"),this.isMobile=Fc()||Cg()}get(){return bE()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rl;function nk(t){E(!rl,"__referenceConstructor has already been defined"),rl=t}function rk(){return E(rl,"Reference.ts has not been loaded"),rl}let ik=1;class $f{constructor(e){this.listenProvider_=e,this.syncPointTree_=new K(null),this.pendingWriteTree_=DT(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function sk(t,e,n,r,i){return ST(t.pendingWriteTree_,e,n,r,i),i?Es(t,new Qn(q_(),e,n)):[]}function vr(t,e,n=!1){const r=CT(t.pendingWriteTree_,e);if(IT(t.pendingWriteTree_,e)){let s=new K(null);return r.snap!=null?s=s.set(z(),!0):Fe(r.children,o=>{s=s.set(new V(o),!0)}),Es(t,new Xo(r.path,s,n))}else return[]}function ws(t,e,n){return Es(t,new Qn(sd(),e,n))}function ok(t,e,n){const r=K.fromObject(n);return Es(t,new rs(sd(),e,r))}function lk(t,e){return Es(t,new ns(sd(),e))}function ak(t,e,n){const r=dd(t,n);if(r){const i=hd(r),s=i.path,o=i.queryId,l=Te(s,e),a=new ns(od(o),l);return fd(t,s,a)}else return[]}function uv(t,e,n,r,i=!1){const s=e._path,o=t.syncPointTree_.get(s);let l=[];if(o&&(e._queryIdentifier==="default"||av(o,e))){const a=tk(o,e,n,r);ZT(o)&&(t.syncPointTree_=t.syncPointTree_.remove(s));const u=a.removed;if(l=a.events,!i){const d=u.findIndex(h=>h._queryParams.loadsAllData())!==-1,c=t.syncPointTree_.findOnPath(s,(h,g)=>wn(g));if(d&&!c){const h=t.syncPointTree_.subtree(s);if(!h.isEmpty()){const g=hk(h);for(let _=0;_<g.length;++_){const y=g[_],A=y.query,m=pv(t,y);t.listenProvider_.startListening(Oi(A),is(t,A),m.hashFn,m.onComplete)}}}!c&&u.length>0&&!r&&(d?t.listenProvider_.stopListening(Oi(e),null):u.forEach(h=>{const g=t.queryToTagMap.get(Ol(h));t.listenProvider_.stopListening(Oi(h),g)}))}fk(t,u)}return l}function cv(t,e,n,r){const i=dd(t,r);if(i!=null){const s=hd(i),o=s.path,l=s.queryId,a=Te(o,e),u=new Qn(od(l),a,n);return fd(t,o,u)}else return[]}function uk(t,e,n,r){const i=dd(t,r);if(i){const s=hd(i),o=s.path,l=s.queryId,a=Te(o,e),u=K.fromObject(n),d=new rs(od(l),a,u);return fd(t,o,d)}else return[]}function ck(t,e,n,r=!1){const i=e._path;let s=null,o=!1;t.syncPointTree_.foreachOnPath(i,(h,g)=>{const _=Te(h,i);s=s||fn(g,_),o=o||wn(g)});let l=t.syncPointTree_.get(i);l?(o=o||wn(l),s=s||fn(l,z())):(l=new iv,t.syncPointTree_=t.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=R.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((g,_)=>{const y=fn(_,z());y&&(s=s.updateImmediateChild(g,y))}));const u=av(l,e);if(!u&&!e._queryParams.loadsAllData()){const h=Ol(e);E(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const g=pk();t.queryToTagMap.set(h,g),t.tagToQueryMap.set(g,h)}const d=Pl(t.pendingWriteTree_,i);let c=ek(l,e,n,d,s,a);if(!u&&!o&&!r){const h=lv(l,e);c=c.concat(mk(t,e,h))}return c}function dv(t,e,n){const i=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,l)=>{const a=Te(o,e),u=fn(l,a);if(u)return u});return J_(i,e,s,n,!0)}function dk(t,e){const n=e._path;let r=null;t.syncPointTree_.foreachOnPath(n,(u,d)=>{const c=Te(u,n);r=r||fn(d,c)});let i=t.syncPointTree_.get(n);i?r=r||fn(i,z()):(i=new iv,t.syncPointTree_=t.syncPointTree_.set(n,i));const s=r!=null,o=s?new yn(r,!0,!1):null,l=Pl(t.pendingWriteTree_,e._path),a=sv(i,e,l,s?o.getNode():R.EMPTY_NODE,s);return KT(a)}function Es(t,e){return hv(e,t.syncPointTree_,null,Pl(t.pendingWriteTree_,z()))}function hv(t,e,n,r){if(D(t.path))return fv(t,e,n,r);{const i=e.get(z());n==null&&i!=null&&(n=fn(i,z()));let s=[];const o=b(t.path),l=t.operationForChild(o),a=e.children.get(o);if(a&&l){const u=n?n.getImmediateChild(o):null,d=Z_(r,o);s=s.concat(hv(l,a,u,d))}return i&&(s=s.concat(cd(i,t,r,n))),s}}function fv(t,e,n,r){const i=e.get(z());n==null&&i!=null&&(n=fn(i,z()));let s=[];return e.children.inorderTraversal((o,l)=>{const a=n?n.getImmediateChild(o):null,u=Z_(r,o),d=t.operationForChild(o);d&&(s=s.concat(fv(d,l,a,u)))}),i&&(s=s.concat(cd(i,t,r,n))),s}function pv(t,e){const n=e.query,r=is(t,n);return{hashFn:()=>(GT(e)||R.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return r?ak(t,n._path,r):lk(t,n._path);{const s=oI(i,n);return uv(t,n,null,s)}}}}function is(t,e){const n=Ol(e);return t.queryToTagMap.get(n)}function Ol(t){return t._path.toString()+"$"+t._queryIdentifier}function dd(t,e){return t.tagToQueryMap.get(e)}function hd(t){const e=t.indexOf("$");return E(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new V(t.substr(0,e))}}function fd(t,e,n){const r=t.syncPointTree_.get(e);E(r,"Missing sync point for query tag that we're tracking");const i=Pl(t.pendingWriteTree_,e);return cd(r,n,i,null)}function hk(t){return t.fold((e,n,r)=>{if(n&&wn(n))return[Al(n)];{let i=[];return n&&(i=ov(n)),Fe(r,(s,o)=>{i=i.concat(o)}),i}})}function Oi(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(rk())(t._repo,t._path):t}function fk(t,e){for(let n=0;n<e.length;++n){const r=e[n];if(!r._queryParams.loadsAllData()){const i=Ol(r),s=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(s)}}}function pk(){return ik++}function mk(t,e,n){const r=e._path,i=is(t,e),s=pv(t,n),o=t.listenProvider_.startListening(Oi(e),i,s.hashFn,s.onComplete),l=t.syncPointTree_.subtree(r);if(i)E(!wn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((u,d,c)=>{if(!D(u)&&d&&wn(d))return[Al(d).query];{let h=[];return d&&(h=h.concat(ov(d).map(g=>g.query))),Fe(c,(g,_)=>{h=h.concat(_)}),h}});for(let u=0;u<a.length;++u){const d=a[u];t.listenProvider_.stopListening(Oi(d),is(t,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function v1(t){YC(Gr),br(new $n("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return d1(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),cn(_f,vf,t),cn(_f,vf,"esm2017")}Pt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Pt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};v1();const Tv={apiKey:"",authDomain:"",databaseURL:"",projectId:"",storageBucket:"",messagingSenderId:"",appId:"",measurementId:""};console.log(Tv);const kv=Rg(Tv),ep="user20@mail.com",tp="PASSWORD",np="psychologists",Dn=4,Ht={asc:"asc",desc:"desc"},Gs=170,Ia={nameAsc:{key:"name",queryConstraint:[rr("name"),$s(Dn+1)],value:"A to Z",sortOrder:Ht.asc},nameDesc:{key:"name",queryConstraint:[rr("name"),Zf(Dn+1)],value:"Z to A",sortOrder:Ht.desc},priceGreater:{key:"price_per_hour",queryConstraint:[rr("price_per_hour"),$s(Dn+1)],additionalQueryConstraint:[Iv(Gs)],value:`Greater than ${Gs}$`,sortOrder:Ht.asc},priceLess:{key:"price_per_hour",queryConstraint:[rr("price_per_hour"),$s(Dn+1),n1(Gs)],value:`Less than ${Gs}$`,sortOrder:Ht.asc},popularAsc:{key:"rating",queryConstraint:[rr("rating"),$s(Dn+1)],value:"Not popular",sortOrder:Ht.asc},popularDesc:{key:"rating",queryConstraint:[rr("rating"),Zf(Dn+1)],value:"Popular",sortOrder:Ht.desc},showAll:{value:"Show all"}};_1(!0);const Ks=qC(kv),rp=m1(kv),y1=()=>{const[t,e]=be.useState(null),[,n]=be.useState([]),[r,i]=be.useState(null),[s,o]=be.useState(null),[l,a]=be.useState(!0),[u,d]=be.useState({...Ia.nameAsc,id:"nameAsc"}),[c,h]=be.useState([]);be.useEffect(()=>{if(!r)return;const p=u.sortOrder===Ht.asc?[Iv(s,r)]:[e1(s,r)];h([...u.queryConstraint,...p])},[r,s,u]),be.useEffect(()=>{const p=u.additionalQueryConstraint?[...u.queryConstraint,...u.additionalQueryConstraint]:[...u.queryConstraint];h(p),a(!0)},[u]),be.useEffect(()=>{const p=async()=>{const v=[];try{const S=l1(Xf(rp,np),...c);(await Jf(S)).forEach(I=>{v.push({key:I.key,...I.val()})}),u.sortOrder===Ht.desc&&v.reverse(),v.length>Dn?(i(v[v.length-1].key),o(v[v.length-1][u.key]),v.pop()):(i(null),o(null)),n(I=>[...I,...v]),a(!1)}catch(S){console.log(S)}};l&&c.length>0&&p()},[c,u,l]);const g=async()=>{try{const p=await AS(Ks,ep,tp),v=await DS(Ks.currentUser,{displayName:"Jane Q. User",photoURL:"https://example.com/jane-q-user/profile.jpg"});console.log(p),console.log(v),e(p.user)}catch(p){console.log(p.code)}},_=async()=>{try{const p=await OS(Ks,ep,tp);console.log(p.user),e(p.user)}catch(p){console.log(p.code)}},y=async()=>{try{await FS(Ks),e(null)}catch(p){console.log(p.code)}},A=async()=>{try{const p=await Jf(il(Xf(rp),np));console.log(p.val())}catch(p){console.log(p)}},m=()=>{a(!0)},f=p=>{const v=p.target.value;n([]),i(null),o(null),d({...Ia[v],id:v})};return fe.jsxs("div",{children:[fe.jsxs("div",{children:[t?fe.jsx("div",{children:t.email}):fe.jsx("div",{children:"Unregistered"}),fe.jsx("button",{onClick:g,children:"SignUp"}),fe.jsx("button",{onClick:_,children:"SignIn"}),fe.jsx("button",{onClick:y,children:"SignOut"})]}),fe.jsxs("div",{children:["DB",fe.jsx("button",{onClick:A,children:"GetData"}),fe.jsx("button",{onClick:m,disabled:!r,children:"Load More Data"}),fe.jsx("select",{value:u.id,onChange:f,children:Object.entries(Ia).map(([p,v])=>fe.jsx("option",{value:p,children:v.value},p))})]})]})};function w1(){return fe.jsx(fe.Fragment,{children:fe.jsx(y1,{})})}Ta.createRoot(document.getElementById("root")).render(fe.jsx(Hv.StrictMode,{children:fe.jsx(w1,{})}));
